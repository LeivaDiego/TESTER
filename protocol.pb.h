...
inline std::string* UserInfo::unsafe_arena_release_status() {
  // @@protoc_insertion_point(field_unsafe_arena_release:chat.UserInfo.status)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return status_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void UserInfo::unsafe_arena_set_allocated_status(
    std::string* status) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (status != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  status_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      status, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:chat.UserInfo.status)
}
...
inline std::string* MessageCommunication::unsafe_arena_release_message() {
  // @@protoc_insertion_point(field_unsafe_arena_release:chat.MessageCommunication.message)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return message_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void MessageCommunication::unsafe_arena_set_allocated_message(
    std::string* message) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (message != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  message_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      message, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:chat.MessageCommunication.message)
}
...
inline std::string* MessageCommunication::unsafe_arena_release_recipient() {
  // @@protoc_insertion_point(field_unsafe_arena_release:chat.MessageCommunication.recipient)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
  return recipient_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void MessageCommunication::unsafe_arena_set_allocated_recipient(
    std::string* recipient) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (recipient != nullptr) {
    _has_bits_[0] |= 0x00000002u;
  ...
  recipient_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      recipient, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:chat.MessageCommunication.recipient)
}
...
inline std::string* MessageCommunication::unsafe_arena_release_sender() {
  // @@protoc_insertion_point(field_unsafe_arena_release:chat.MessageCommunication.sender)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000004u;
  return sender_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void MessageCommunication::unsafe_arena_set_allocated_sender(
    std::string* sender) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (sender != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  ...
  sender_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      sender, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:chat.MessageCommunication.sender)
}
...
inline ::chat::MessageCommunication* ClientPetition::release_messagecommunication() {
  auto temp = unsafe_arena_release_messagecommunication();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
